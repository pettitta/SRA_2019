...
model_3_1 <- lmer(daily ~ fpp_n.state*imean.fpp_n.c + (diff_days|participant_id), daily_text_pronouns,REML=FALSE)
...
interact_plot(model_3_1,imean.fpp_n.c,fpp_n.state,interval=TRUE)
